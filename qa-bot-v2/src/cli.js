...
async function main() {
  ...
  if (!testName) {
    throw new Error("Usage: node src/cli.js <login|logout|search|search-flexible|contract-request|contract-cancel-request|contract-cancel-confirmed|contract-approve|contract-payment> --env=staging --role=guest");
  }
